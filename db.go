...
func connect() {
	...
	_ = db.Create(&dGroupe).Error

	dTerritoire := Territoire{
		CodeStructure: "1",
	}
	_ = db.Create(&dTerritoire).Error

	dUser := User{
		CodeAdherent:            "1",
		Role:                    "jeune",
		CodeStructureGroupe:     "1",
		CodeStructureTerritoire: "1",
	}
	_ = db.Create(&dUser).Error

	dUser2 := User{
		CodeAdherent:            "2",
		Role:                    "jeune",
		CodeStructureGroupe:     "2",
		CodeStructureTerritoire: "1",
	}
	_ = db.Create(&dUser2).Error
	...
	_ = db.Create(&dUser3).Error

	dProgression1 := Progression{
		ID:           "1",
		ActiviteCode: "1",
		ParcoursCode: "1",
		State:        "INPROGRESS",
	...
	_ = db.Create(&dProgression1).Error

	dProgression2 := Progression{
		ID:           "2",
		ActiviteCode: "1",
		ParcoursCode: "1",
		State:        "INPROGRESS",
	...
	_ = db.Create(&dProgression2).Error

	dProgression3 := Progression{
		ID:           "3",
		ActiviteCode: "1",
		ParcoursCode: "1",
		State:        "INPROGRESS",
	...
	_ = db.Create(&dProgression3).Error

	dProgression4 := Progression{
		ID:           "4",
		ActiviteCode: "1",
		ParcoursCode: "1",
		State:        "INPROGRESS",
	...
	_ = db.Create(&dProgression4).Error
